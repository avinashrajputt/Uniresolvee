...
const Hero = React.memo(function Hero() {
  return (
    <section id="home" className="w-full bg-gradient-to-b from-[#071026] via-[#0a1435] to-[#071026] text-white py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7 lg:col-span-7 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-500/30 mb-6 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-indigo-300">AI-Powered Assessment Platform</span>
            </div>
            
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold leading-tight mb-5">
              <span className="bg-gradient-to-r from-white via-indigo-100 to-purple-200 bg-clip-text text-transparent">UniResolve</span>
              <br />
              <span className="text-white">Automated Assessment for</span>
              <br />
              <span className="bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">Universities</span>
            </h1>
            
            <p className="text-base md:text-lg text-gray-300 max-w-3xl md:max-w-none md:pr-8 mb-6 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-3 justify-center md:justify-start">
              ...
              <a href="#contact" className="inline-flex items-center justify-center gap-2 border-2 border-indigo-500/30 hover:border-indigo-500/50 bg-indigo-500/10 hover:bg-indigo-500/20 text-white px-6 py-3 rounded-xl font-semibold backdrop-blur-sm transition-all duration-300 hover:scale-105">
