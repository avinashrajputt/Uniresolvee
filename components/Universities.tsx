...
const Universities = React.memo(function Universities() {
  return (
    <section id="universities" className="w-full bg-gradient-to-b from-[#071026] via-[#0a1435] to-[#071026] py-12 text-white relative overflow-hidden">
      ...
      <div className="w-full px-6 lg:px-12 relative z-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border border-blue-500/30 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-blue-300">Educational Excellence</span>
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-4xl font-extrabold mb-3">
            Trusted by <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Leading Universities</span>
          </h2>
          <p className="text-base text-gray-300 max-w-2xl mx-auto">Join hundreds of educational institutions using our platform for accurate assessments.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {universities.map((u, idx) => (
            <div 
              key={u.name} 
              className="group relative p-6 rounded-2xl bg-gradient-to-br from-[#0b1220]/80 to-[#0f1a2b]/80 border border-white/10 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20"
