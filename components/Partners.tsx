...
const Partners = React.memo(function Partners() {
  return (
    <section id="partners" className="w-full bg-gradient-to-b from-[#071026] via-[#0a1435] to-[#071026] text-white py-12 relative overflow-hidden">
      ...
      <div className="w-full px-6 lg:px-12 relative z-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-600/20 to-emerald-600/20 border border-green-500/30 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-green-300">Strategic Partnerships</span>
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-4xl font-extrabold mb-3">
            Partnered with <span className="bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">Leading Exam Bodies</span>
          </h2>
          <p className="text-base text-gray-300 max-w-2xl mx-auto">Trusted by major testing organizations worldwide for reliable assessment solutions</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {partners.map((p, idx) => (
            <div 
              key={p.name} 
              className="group relative p-6 rounded-2xl bg-gradient-to-br from-[#0b1220]/80 to-[#0f1a2b]/80 border border-white/10 backdrop-blur-sm hover:border-green-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20"
